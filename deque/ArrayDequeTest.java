...
public class ArrayDequeTest {
    ...
    public void continuousaddtest(){
        ...
        for (int i = 0; i < 8; i++) {
            assertEquals((Integer)i, test1.get(i));
    ...
    public void testMaxArray() {
        ...
        MaxArrayDeque<Integer> a = new MaxArrayDeque<>(comp);
        for (int i = 0; i < 100; i++) { a.addLast(i); }

        assertEquals(new Integer(99), a.max());

        MaxArrayDeque<String> b = new MaxArrayDeque<String>(comp2);
        b.addLast("zebra");
        b.addLast("horse");
        b.addLast("apple");
        b.addLast("starfish");

        assertEquals("zebra", b.max(comp2));
    }
    @Test
    public void test_max_arrayEquals() {
        Comparator<Integer> comp = new Comparator<Integer>() {
            @Override
            public int compare(Integer o1, Integer o2) {
                return o1 - o2;
        ...
        MaxArrayDeque<Integer> a = new MaxArrayDeque<Integer>(comp);
        MaxArrayDeque<Integer> b = new MaxArrayDeque<>(comp);
        for (int i = 0; i < a.size(); i++) {
            a.addLast(i);
            b.addLast(i);
        }
